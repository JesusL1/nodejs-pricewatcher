...
const Home = () => {
    return (
        <div id="about" className="margin-t">
            <div className="info">
            ...
            <div className="info">
                <h1> How It Works </h1>
                <ol type="1">
                    <li> View the list of <span style={{fontStyle: 'italic' }}> Supported Websites</span> before searching a product. </li>
                    <li> Copy and paste the URL of the product page into the search bar above. </li>
                    <li> Click the "Add to Price Alerts" button. </li>
